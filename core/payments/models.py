...
class ReconciliationThread(models.Model):
    ...
    is_internal = models.BooleanField('فقط کارکنان', default=False, help_text='اگر فعال باشد، این thread از دید مشتری پنهان است.')
...
class ReconciliationMessage(models.Model):
    ...
    is_internal = models.BooleanField('فقط کارکنان', default=False, help_text='اگر فعال باشد، این پیام از دید مشتری پنهان است.')
...
class ReconciliationMessageLog(models.Model):
    ...
    ACTION_INFO = 'info'
    ACTION_CHOICES = [(ACTION_EDIT, 'ویرایش'), (ACTION_DELETE, 'حذف'), (ACTION_VISIBILITY, 'تغییر دیدپذیری'), (ACTION_INFO, 'مشاهده اطلاعات')]
...
class SystemSettings(models.Model):
    ...
    customer_warranty_menu_enabled = models.BooleanField(
        'نمایش منوی «خدمات پس از فروش» برای مشتریان',
        default=False,
