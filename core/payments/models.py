...
class PaymentRecord(models.Model):
    ...
    payer_first_name = models.CharField(max_length=64, blank=True, default='')
    payer_last_name = models.CharField(max_length=64, blank=True, default='')
    payer_bank_name = models.CharField(max_length=64, blank=True, default='')
    payer_bank_branch = models.CharField(max_length=64, blank=True, default='')
